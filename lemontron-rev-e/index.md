...
{% include tip.html
title = "Rev E is available to download and make!"
tip = "However, the build guide doesn't exist! To build Rev E, you have to refer to the Rev A build guide and use
